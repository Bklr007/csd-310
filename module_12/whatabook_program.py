...
try:
    ...
    print("\n  Welcome to Your Online Whatabook Store! Have Fun!")
    ...
    while user_selection != 4:
        ...
        if user_selection == 3:
            ...
            while account_option != 3:
                ...
                if account_option == 2:
                    ...
                    print("\n        Book id: {} was successfully added to your wishlist! Let's Celebrate!".format(book_id))

                # if the selected option is less than 0 or greater than 3, display an invalid user selection 
                if account_option < 0 or account_option > 3:
                    print("\n     Oops! Invalid Entry! Let's Try That Again!")
        ...
        if user_selection < 0 or user_selection > 4:
            print("\n      Bummer! Invalid option, Try Again!")
            
        # show the main menu
        user_selection = show_menu()

    print("\n\n  Program terminated...Have a Fabulous Day!")

except mysql.connector.Error as err:
    """ handle errors """ 

    if err.errno == errorcode.ER_ACCESS_DENIED_ERROR:
        print("  The supplied username or password are invalid!  Give It Another Shot!")

    elif err.errno == errorcode.ER_BAD_DB_ERROR:
        print("  The specified database does not exist!  Let's Try Again!")
